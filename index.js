...
var payment_user_billing_key_1 = require("./interfaces/payment-user-billing-key");
var report_file_1 = require("./interfaces/report-file");
...
(function (HelperPaymentSubscription) {
    HelperPaymentSubscription.valid = function (paymentSubscription) {
        for (var _i = 0, PaymentSubscriptionRequired_1 = payment_subscription_1.PaymentSubscriptionRequired; _i < PaymentSubscriptionRequired_1.length; _i++) {
            var key = PaymentSubscriptionRequired_1[_i];
            if (notOk(paymentSubscription[key]))
                return false;
        }
        return true;
    };
})(HelperPaymentSubscription = exports.HelperPaymentSubscription || (exports.HelperPaymentSubscription = {}));
var HelperPaymentUserBillingKey;
(function (HelperPaymentUserBillingKey) {
    HelperPaymentUserBillingKey.valid = function (paymentUserBillingKey) {
        for (var _i = 0, PaymentUserBillingKeyRequired_1 = payment_user_billing_key_1.PaymentUserBillingKeyRequired; _i < PaymentUserBillingKeyRequired_1.length; _i++) {
            var key = PaymentUserBillingKeyRequired_1[_i];
            if (notOk(paymentUserBillingKey[key]))
                return false;
        }
        return true;
    };
})(HelperPaymentUserBillingKey = exports.HelperPaymentUserBillingKey || (exports.HelperPaymentUserBillingKey = {}));
var HelperProduct;
...
var HelperReportFile;
(function (HelperReportFile) {
    HelperReportFile.valid = function (reportFile) {
        for (var _i = 0, ReportFileRequired_1 = report_file_1.ReportFileRequired; _i < ReportFileRequired_1.length; _i++) {
            var key = ReportFileRequired_1[_i];
            if (notOk(reportFile[key]))
                return false;
        }
        return true;
    };
})(HelperReportFile = exports.HelperReportFile || (exports.HelperReportFile = {}));
